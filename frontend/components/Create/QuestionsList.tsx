...
// const QuestionsList: React.FC<QuestionsListProps> = ({ roomId, fetchQuestions, showQuestions, toggleShowQuestions, roomQuizDuration }) => {
...
//           className="bg-gray-800 hover:bg-gray-950 text-white font-bold  px-4 rounded focus:outline-none focus:shadow-outline"
//         >
//           Back to Dashboard
//         </button>
//         <button
...
//       {showQuestions && (
//         <div>
//           <h2 className="text-xl my-2">Current Questions Added</h2>
//           {loading ? (
